...
const StartFunc = ({ inQrcodeArray, inBranchName }) => {
    ...
    const LocalFilteredArray = LocalQrcodeArray.filter(element => {
        return element[CommonFilterKey] === true || element[CommonFilterKey3] === true ||element[CommonFilterKey4] === true && element[CommonFilterKey2] === false && element.BranchName === inBranchName;
    });
