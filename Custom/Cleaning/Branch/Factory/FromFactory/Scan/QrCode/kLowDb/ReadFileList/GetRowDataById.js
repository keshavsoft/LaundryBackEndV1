...
let StartFunc = ({ inFactory, inId }) => {
    ...
    let LocalFilterQr = Qrdb.data.filter(e => e.BookingData.OrderData.BranchName === LocalBranchName);

    let LocalFilterEntryScan = EntryScandb.data.filter(e => e.BranchName === LocalBranchName);
