...
let GetToPrintOnlyFuncs = ({ inBranch, inFromDate, inToDate }) => {
    return ToPrintOnly({ inBranch, inFromDate, inToDate });
};
...
let GetShowAllFunc = async ({ inBranch, inFromDate, inToDate }) => {
    let LocalFromLowDb = await StartFuncFromGetShowAll({ inBranch, inFromDate, inToDate });
