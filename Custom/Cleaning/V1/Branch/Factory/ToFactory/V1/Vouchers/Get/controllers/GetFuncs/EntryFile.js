...
let GetToPrintOnlyFuncs = (req, res) => {
    ...
    let LocalFromRepo = GetToPrintOnlyFuncsRepo({ inBranch: LocalBranch, inFromDate: LocalFromDate, inToDate: LocalToDate });
...
let GetShowAllFunc = async (req, res) => {
    ...
    let LocalFromDate = LocalParams.inFromDate;
    let LocalToDate = LocalParams.inToDate;
    let LocalFromRepo = await GetShowAllFuncRepo({ inBranch: LocalBranch, inFromDate: LocalFromDate, inToDate: LocalToDate });
