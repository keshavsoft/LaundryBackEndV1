import {
    ...
    GetAllFunc as GetAllFuncRepo,
    GetScannedWithOutFilterFunc as GetScannedWithOutFilterFuncRepo
...
let GetAllFunc = async (req, res) => {
    let LocalParams = req.params;
    let LocalBranch = LocalParams.inBranch;
    let LocalFromRepo = GetAllFuncRepo({ inBranch: LocalBranch });

    res.status(200).json(LocalFromRepo);
};

let GetScannedWithOutFilterFunc = async (req, res) => {
    let LocalParams = req.params;
    let LocalBranch = LocalParams.inBranch;
    let LocalFromRepo = GetScannedWithOutFilterFuncRepo({ inBranch: LocalBranch });
