...
const jFLocalFactoryWideData = ({ inData, fromDate, toDate }) => {
    ...
    return inData
        .filter(e => {
            ...
            const itemDate = e.EntryScanDate.split('/').join('-').replace(/\//g, '-');
...
export { StartFunc };
// let localdata = StartFunc({ inFactory: "Vizag", fromDate: "24-03-2025", toDate: "25-03-2025" }); console.log("localdata", localdata);
